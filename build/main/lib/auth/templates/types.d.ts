...
export declare type AuthenticationVirtualMachineIdentifier = 'BCH_2018_11' | 'BCH_2019_05' | 'BSV_2018_11' | 'BTC_2017_08';
...
export interface AuthenticationTemplateChecksumScript extends AuthenticationTemplateScript {
    /**
 ...
 * contextual TypeDocs.
 */
export interface AuthenticationTemplateVariableKey extends AuthenticationTemplateVariableBase {
    /**
...
export declare type AuthenticationTemplateVariable = HDKey | Key | WalletData | TransactionData | CurrentBlockTime | CurrentBlockHeight | ExternalOperation;
